...
cover:
abbrlink: cc1b9611
date: 2022-09-03 19:54:00
updated: 2022-09-03 19:54:00
---
...
//操作非内联样式
window.getComputedStyle(); //接受一个DOM节点对象作为参数，返回一个包含该节点最终样式信息的对象

//伪类
window.getComputedStyle(el, ":after")[attrName];

//伪元素
//StyleSheet对象  https://www.jianshu.com/p/09a27917e70e
```
